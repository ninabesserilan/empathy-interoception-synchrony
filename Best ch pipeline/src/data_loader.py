import pickle
from config import Config_03_json_empathy_18, Config_03_json_empathy_9
from pathlib import Path


pickle_path_18m = Path(Config_03_json_empathy_18['save_path']) / f"{Config_03_json_empathy_18['peaks_prefix']}.pkl"

pickle_path_9m = Path(Config_03_json_empathy_9['save_path']) / f"{Config_03_json_empathy_9['peaks_prefix']}.pkl"
