...
new_interpolation = Path('/Users/nina/Desktop/University of Vienna/PhD projects/python code/interoception-synchrony/RSA analysis/Improved best ch after interpolation.pkl')
save_stats_path = parent_dir /'IBIS statistics post interpolation.xlsx'
