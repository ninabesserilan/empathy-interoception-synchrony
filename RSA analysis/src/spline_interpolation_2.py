...
import copy
import pickle
from spline2 import make_index_interpolator


def apply_gap_filling_to_data_dict_2(data_dict, factor=2, infant_ibis_th=600, 
...
def ibis_interpolation_spline(ibi_arr, factor=2, tension=0.2): # Should we do factor = 1.5?
    ...
    interpolator = make_index_interpolator(ibi_indexed, tension=tension, alpha=0.0)
